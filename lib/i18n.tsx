...
const dict = {
  ...
  "candidates.mentions": { es: "titulares", en: "headlines" },
  "candidates.mention": { es: "titular", en: "headline" },
  "candidates.sources": { es: "medios", en: "outlets" },
  "candidates.source": { es: "medio", en: "outlet" },
  "candidates.onlyOne": { es: "un solo medio", en: "single outlet" },
  "candidates.onlyOneWhy": {
    es: "Todos sus titulares salen de la misma redacción: puede ser una lista de un solo artículo, no algo que varios medios estén viendo.",
    en: "Every headline comes from the same newsroom: it may be one article's listicle, not something several outlets are seeing.",
  },
  ...
  "candidates.rank": {
    es: "Por medios distintos que la mencionan",
    en: "By distinct outlets mentioning it",
  },
  ...
  "curator.title": { es: "Fotos de tendencias", en: "Trend photos" },
  "curator.subtitle": {
    es: "Pega la URL de una imagen, su crédito y el enlace al original. Se comprueba que cargue antes de guardarla.",
    en: "Paste an image URL, its credit and the link to the original. It is checked before being saved.",
  },
  "curator.missing": { es: "sin foto curada", en: "without a curated photo" },
  "curator.total": { es: "en total", en: "in total" },
  "curator.showAll": { es: "Ver todas", en: "Show all" },
  "curator.showMissing": { es: "Ver solo las que faltan", en: "Show only missing" },
  "curator.none": { es: "Sin foto", en: "No photo" },
  "curator.fromPanel": { es: "Curada aquí", en: "Curated here" },
  "curator.fromContent": { es: "Curada en content/", en: "Curated in content/" },
  "curator.fromFeed": { es: "Del feed", en: "From the feed" },
  "curator.urlPlaceholder": {
    es: "https://… URL de la imagen",
    en: "https://… image URL",
  },
  "curator.creditPlaceholder": { es: "Crédito (Vogue México)", en: "Credit (Vogue México)" },
  "curator.creditUrlPlaceholder": {
    es: "https://… enlace al original",
    en: "https://… link to the original",
  },
  "curator.previewNote": {
    es: "Vista previa desde el origen. Si aquí no carga, tampoco cargará en la app.",
    en: "Preview straight from the source. If it does not load here, it will not load in the app.",
  },
  "curator.save": { es: "Comprobar y guardar", en: "Check and save" },
  "curator.checking": { es: "Comprobando…", en: "Checking…" },
  "curator.remove": { es: "Quitar", en: "Remove" },
  "curator.failed": { es: "No se pudo guardar.", en: "Could not save." },
  "curator.hostApproved": {
    es: "Host aprobado y guardado:",
    en: "Host approved and saved:",
  },
  "curator.approvedHosts": { es: "Hosts aprobados", en: "Approved hosts" },
  "curator.allDone": {
    es: "Todas tienen foto. Cambia a “Ver todas” para reemplazar alguna.",
    en: "They all have a photo. Switch to “Show all” to replace one.",
  },
